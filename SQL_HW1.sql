...
SELECT TOP 6 'Name:' + Name + ' -- COLOR:' + Color FROM Production.Product WHERE Name like '%[alNi][rtun][gmst]' and Color is not null;
...
SELECT TOP 6 Name,ListPrice FROM Production.Product WHERE NAME LIKE 'S[eh]%' AND (ListPrice=0.00 OR ListPrice=53.99) ORDER BY Name;
